import type { GarminDomain, GCGearId, GCUserProfileId, GCWorkoutId } from './types';
import type { GCActivityId } from './types/activity';
...
export class UrlClass {
  ...
  CALENDAR_WEEK(year: number, month: number, day: number, firstDateOfWeek: number = 1) {
